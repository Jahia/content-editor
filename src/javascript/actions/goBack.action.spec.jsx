...
describe('go back action url resolution', () => {
    ...
    it('Should resolve parent url parent correctly', () => {
        ...
        testGoBackContextResolution('/sites/digitall/contents', '/sites/digitall', 'digitall', '/sites/digitall/contents', 'content-folders', false);
        ...
        testGoBackContextResolution('/sites/digitall/contents/contentA', '/sites/digitall/contents', 'contents', '/sites/digitall/contents', 'content-folders', true);
        ...
        testGoBackContextResolution('/sites/digitall/contents/listA/contentA', '/sites/digitall/contents/listA', 'listA', '/sites/digitall/contents/listA', 'content-folders', true);
        ...
        testGoBackContextResolution('/sites/digitall/contents/listA/listB/listC/contentA', '/sites/digitall/contents/listA/listB/listC', 'listC', '/sites/digitall/contents/listA/listB/listC', 'content-folders', true);

...
export const {cePickerSite, cePickerContextSite, cePickerMode, cePickerOpenPaths, cePickerClosePaths, cePickerPath, cePickerClearOpenPaths} = createActions('CE_PICKER_SITE', 'CE_PICKER_CONTEXT_SITE', 'CE_PICKER_MODE', 'CE_PICKER_OPEN_PATHS', 'CE_PICKER_CLOSE_PATHS', 'CE_PICKER_PATH', 'CE_PICKER_CLEAR_OPEN_PATHS');

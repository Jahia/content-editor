...
export const getPickerDialog = (/* damSelectorConfig, field */) => {
    // If (!damSelectorConfig) {
    //     return null;
    // }
    // const key = `${damSelectorConfig.key}Dialog`;
    // if(key === "PickerDialog")
    //     return window.CE_API.openPicker
    //
    // let selectorType = registry.get('selectorType', key);
    //
    // return selectorType;
};

...
export const registerMultipleLeftRightSelectorOnChange = registry => {
    registry.add('selectorType.onChange', 'addMixinChoicelist2', {
        targets: ['MultipleLeftRightSelector'],

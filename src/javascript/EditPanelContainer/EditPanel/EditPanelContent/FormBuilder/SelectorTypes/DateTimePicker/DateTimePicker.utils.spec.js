...
describe('DateTime picker utils', () => {
    describe('fillDisabledDaysFromJCRConstraints', () => {
        ...
        tests.forEach(test => {
            ...
            it('should return the disabledDays on date variant regarding the provided JCR Constraints for ' + testField.formDefinition.valueConstraints[0].value.string, () => {
                expect(fillDisabledDaysFromJCRConstraints(testField, false)).toEqual(test.result.date);
            });
            it('should return the disabledDays on datetime variant regarding the provided JCR Constraints for ' + testField.formDefinition.valueConstraints[0].value.string, () => {

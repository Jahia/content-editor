...
public final class EditorFormFieldSetTest {
    ...
    public void mergeWithReturnsThisUnmodifiedWhenNodeTypeDoesNotMatch() {
        ...
        assertEquals(new EditorFormFieldSet("form1", "form1DisplayName", "form1Description", 1.0, 1.0, false, false, true, true,Collections.emptySet()), result);
    }
    ...
    public void mergeWithDoesNotRetainRemovedFields() {
        final EditorFormFieldSet form1 = new EditorFormFieldSet("form", "displayName", "description", 1.0, 1.0, false, false, true, true, new HashSet<>(Arrays.asList(
                new EditorFormFieldBuilder("x").removed(true).build(),
                new EditorFormFieldBuilder("y").build()
        )));
        final EditorFormFieldSet form2 = new EditorFormFieldSet("form", "displayName", "description", 1.0, 1.0, false, false, true, true, new HashSet<>(Arrays.asList(
    ...
    public void mergeWithDoesNotAddRemovedFields() {
        final EditorFormFieldSet form1 = new EditorFormFieldSet("form", "displayName", "description", 1.0, 1.0, false, false, true, true, Collections.singleton(
            new EditorFormFieldBuilder("x").build()
        ));
        final EditorFormFieldSet form2 = new EditorFormFieldSet("form", "displayName", "description", 1.0, 1.0, false, false, true, true, Collections.singleton(
            new EditorFormFieldBuilder("y").removed(true).build()
        ));
